...
Zephyr folgt einer anderen Herangehensweise als andere Cloud-An­bie­ter. Es lässt sich direkt in den Vite-Build-Prozess integrieren, dass jedes Mal, wenn Sie Ihre Anwendung bauen oder den Entwicklungsserver ausführen, die Anwendung automatisch mit Zephyr Cloud bereitgestellt wird.

Folgen Sie den Schritten im [Leitfaden zur Bereitstellung mit Vite](https://docs.zephyr-cloud.io/recipes/react-vite), um zu beginnen.